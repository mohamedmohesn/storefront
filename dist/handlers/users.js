...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                newProduct = _a.sent();
                token = jsonwebtoken_1["default"].sign({ user: newProduct }, process.env.TOKEN);
...
var authenticate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var firstName, password, newProduct, token, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                firstName = req.body.firstName;
                password = req.body.password;
                return [4 /*yield*/, store.authenticate(firstName, password)];
            case 1:
                newProduct = _a.sent();
                if (newProduct !== null) {
                    token = jsonwebtoken_1["default"].sign({ user: newProduct }, process.env.TOKEN);
...
var UserRoutes = function (app) {
    app.get('/user', middleware_1.verifyToken, index);
    app.get('/user/:id', middleware_1.verifyToken, show);
    app.post('/user/signup', create);
    app.post('/user/login', authenticate);
    app["delete"]('/user/:id', middleware_1.verifyToken, destroy);
};
