...
var findcategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
var ProductRoutes = function (app) {
    ...
    app.get('/product/category/:category', middleware_1.verifyToken, findcategory);
    app.post('/product', middleware_1.verifyToken, create);
    app["delete"]('/product/:id', middleware_1.verifyToken, destroy);
};
