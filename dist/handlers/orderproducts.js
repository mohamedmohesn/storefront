...
var orderproductRoutes = function (app) {
    app.get('/orderproduct', middleware_1.verifyToken, index);
    app.get('/orderproduct/:id', middleware_1.verifyToken, show);
    app.post('/orderproduct', middleware_1.verifyToken, create);
    app["delete"]('/orderproduct/:id', middleware_1.verifyToken, destroy);
};
